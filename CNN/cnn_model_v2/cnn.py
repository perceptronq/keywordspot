...
class KeywordSpottingTrainer:
    ...
    def train(self, train_loader, test_loader, label_encoder, epochs=100):
        model = KeywordSpottingCNN(num_classes=len(label_encoder.classes_)).to(self.device)
        ...
        for epoch in range(epochs):
            ...
            if val_acc > best_accuracy:
                ...
                torch.save(model.state_dict(), self.output_dir / 'cnn_model.pth')
...
def main():
    ...
    trainer = KeywordSpottingTrainer(
        ...
        output_dir='./cnn_model_v2new'
    )
    
    label_encoder = trainer.prepare_data()
